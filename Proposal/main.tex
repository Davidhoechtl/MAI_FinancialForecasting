...
As a proof of concept (PoC), the work will analyse an ARMA model with and without sentiment integration. Later, more complex AI models – ranging from XGBoost to recurrent neural networks (RNN), long short-term memory networks (LSTM), and state-of-the-art transformer models like GPT – 5 may be evaluated and benchmarked. To analyse performance, metrics such as Mean Percentage Error (MPE), Accuracy, and F1-Score will be used.
