...
\section{Goals}
The goal of this study is to quantify the benefit of market-sentiment to predict changes in stock prices. Different AI-algorithms will be compared and analysed to determine which would benefit the most from this new feature.
