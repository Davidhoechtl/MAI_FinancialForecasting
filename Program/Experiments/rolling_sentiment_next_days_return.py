...
for i in [1,5,30,60,120,200]:
    ...
    df_combined[target_col] = df_combined['Close'].pct_change(periods=i).shift(-i)
    ...
    df_corr = plot_rolling_sentiment_correlations(df_combined, sentiment_col, target_col)
